...
import com.androdr.data.db.MIGRATION_11_12
import com.androdr.data.db.MIGRATION_12_13
import com.androdr.data.db.MIGRATION_13_14
...
object AppModule {
    ...
    @Provides
    fun provideFeedHealthDao(db: AppDatabase): FeedHealthDao = db.feedHealthDao()
